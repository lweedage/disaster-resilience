...
def find_zip_code_region(zip_codes, city=None):
    ...
    zip_code_region_data = util.from_data(f'data/BSs/{city[0]}zip_code_region_data.p')
    ...
    if zip_code_region_data is None:
        ...
        util.to_data(region, f'data/BSs/{city[0]}region.p')
...
def load_bs(region, zip_code_region, city):
    ...
    if all_basestations is None:
        ...
        util.to_data(ys, f'data/BSs/{city}_ys.p')
