...
municipalities = ['Emmen', 'Aa en Hunze', 'Tynaarlo', 'Noordenveld', 'Assen', 'Westerveld', 'Meppel', 'Hoogeveen',
                  'De Wolden', 'Coevorden', 'Borger-Odoorn']
...
for municipality in municipalities:
    ...
    for mno in MNOs:
        ...
        delta = 100
        params = p.Parameters(seed, zip_codes, mno, percentage, buffer_size=2000, city_list=cities, province=province,
                              delta=delta, radius_disaster=radius_disaster, random_failure=random_failure)
